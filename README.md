...
* Noise:
  ...
  * New method (SCRAPPED): use a NoiseManager class which generates chunks at world generation in a centralised way and returns the normalisation ratio as well as the chunk's noise map.
